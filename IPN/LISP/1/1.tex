...
\begin{document}
    ...
    \markboth{Taller de programación en Common LISP}{}
    \maketitle
    ...
    \section{1}
        ...
        \lstinputlisting[language=lisp, gobble=8]{Code/1a.lisp}

        El número de segundos que tiene el año bisiesto 2004.
        \lstinputlisting[language=lisp, gobble=8]{Code/1b.lisp}
        ...
        \lstinputlisting[language=lisp, gobble=8]{Code/1c.lisp}

        Una lista con las dos soluciones reales de la ecuación
        \lstinputlisting[language=lisp, gobble=8]{Code/1d.lisp}

    \clearpage
    \section{2}
        Escriba, en notación prefija y evalúe las siguientes expresiones aritméticas:
        \begin{itemize}
            \item a) \lstinputlisting[language=lisp, gobble=8]{Code/2a.lisp}
            \item b) \lstinputlisting[language=lisp, gobble=8]{Code/2b.lisp}
            \item c) \lstinputlisting[language=lisp, gobble=8]{Code/2c.lisp}
            \item d) \lstinputlisting[language=lisp, gobble=8]{Code/2d.lisp}
        \end{itemize}
    ...
    \section{4}
        ...
        ( ((x y) . A) ((y z) . C) ((z y x) . B) )
        \lstinputlisting[language=lisp, gobble=8]{Code/4.lisp}
    ...
    \section{5}
        ...
        \lstinputlisting[language=lisp, gobble=8]{Code/5.lisp}
    ...
    \section{6}
        ...
        lista vacía?
        \lstinputlisting[language=lisp, gobble=8]{Code/6.lisp}
    ...
    \section{7}
        ...
        \lstinputlisting[language=lisp, gobble=8]{Code/7.lisp}
    ...
    \section{8}
        ...
        \lstinputlisting[language=lisp, gobble=8]{Code/8.lisp}
    ...
    \section{9}
        ...
        \lstinputlisting[language=lisp, gobble=8]{Code/9.lisp}
    ...
    \section{10}
        ...
        \lstinputlisting[language=lisp, gobble=8]{Code/10.lisp}
