...
\title{Practica #4: Multiples Rutas}
...
\section{Practica 4}
  ...
  Muy buena practica, despues de haber creado la topologia basta con hacer una especia de crawler que vaya al R4, y captura su IP, 
  de ahi se mueve a cada uno de los routes, y captura su IP de la misma manera, una vez que existan todos los datos
  basta con hacer los pasos para configurar las cosas manual (la mas facil de hacer), luego levantar RIP en los indicados
  y finalmente hacer lo mismo con OSPF.
  ...
  Evidencias
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{fake0}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{fake1}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{fake2}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{fake3}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{fake4}
  \end{figure}

  \clearpage

  Script realizado:    
  \lstinputlisting[language=python]{mutiple.py}
