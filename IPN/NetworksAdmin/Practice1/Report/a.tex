...
\title{Practica 1: Conociendo GNS3}
...
\markboth{Administración de servicios en red - 4CM1}{}
...
\section{Practica 1}
  ...
  \begin{figure}[ht!]
    \includegraphics[width=0.85\textwidth]{x2}
    \caption{Iniciar GNS3}
  \end{figure}

  \begin{figure}[ht!]
    \includegraphics[width=0.85\textwidth]{new1}
    \caption{Usar el area de trabajo para colocar los componentes en el canvas}
  \end{figure}

  \begin{figure}[ht!]
    \includegraphics[width=0.85\textwidth]{x4}
    \caption{Crear dos maquinas virtuales \Quote{lightweight}}
  \end{figure}

  \begin{figure}[ht!]
    \includegraphics[width=0.85\textwidth]{x5}
    \caption{Desde la maquina virtual configurar las conexiones}
  \end{figure}

  \begin{figure}[ht!]
    \includegraphics[width=0.85\textwidth]{x6}
    \caption{Editar la configuracion de IPv4}
  \end{figure}

  \begin{figure}[ht!]
    \includegraphics[width=0.85\textwidth]{x7}
    \includegraphics[width=0.85\textwidth]{x8}
    \caption{Editamos el router con la configuracion dada en las dos interfaces}
  \end{figure}

  \begin{figure}[ht!]
    \includegraphics[width=0.85\textwidth]{x9}
    \includegraphics[width=0.85\textwidth]{new4}
    \caption{Ahora podemos hacer hacer ping}
  \end{figure}
  ...
  \section{Preguntas}
    \begin{itemize}
        ...
        \texttt{enable} para el primero y \texttt{configure} para el segundo.
        \item ¿Cuál es el comando utilizado para que el dispositivo muestre la tabla de enrutamiento? 
        \texttt{show ip interface brief}
        \item ¿Cuál es la fuente de información o de qué tipo son las rutas mostradas por este comando? las tablas
        de enrumatiento del router en ese momento.
        \item ¿Cuál es la capa del modelo OSI sobre la que se realizan principalmente estas 
        funciones de comunicación? 
        En el nivel de red
        \item Si una PC requiere enviar paquetes hacia otra PC que 
        se encuentra en una red distinta ¿hacia qué dispositivo son enviados estos paquetes? 
        A un router y este lo va enviando hasta que un router se los envia a la computadora correcta.
    \end{itemize}
