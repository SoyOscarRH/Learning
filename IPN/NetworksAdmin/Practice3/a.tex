...
\title{Practica #3: Pexpect & SSH / Telnet}
...
\section{Practica 3}
  ...
  Evidencias
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{P32}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{P33}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{P34}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{P35}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{P36}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{P37}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{P38}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{P39}
  \end{figure}

  \clearpage

  Script realizado:    
  \lstinputlisting[language=python]{create_ssh.py}
