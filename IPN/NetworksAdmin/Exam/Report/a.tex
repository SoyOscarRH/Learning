...
\section{Examen Practico}
  ...
  Evidencias
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{E2}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{E3}
  \end{figure}

  Script realizado:    
  \lstinputlisting[language=python]{find_net.py}
