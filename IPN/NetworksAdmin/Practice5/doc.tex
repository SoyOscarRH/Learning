...
\section{Tarea NAT y DHCP}

  Muy buena practica, fue muy interesante finalmente entender como funciona DHCP y como
  como se configura un servidor NAT
  ...
  Evidencias
  \begin{figure}[ht]
    \includegraphics[width=0.85\textwidth]{Examples1}
  \end{figure}
  \begin{figure}[ht]
    \includegraphics[width=0.85\textwidth]{Examples2}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{Examples3}
  \end{figure}
