...
\title{Practica #2: Enrutamiento estatico / SSH / Telnet}
...
\section{Practica 2}
  ...
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{p2img3}
    \caption{Iniciar GNS3 y hacer conexiones}
  \end{figure}


  \begin{lstlisting}
    2) Abrir consola del router 1
    enable
    configure terminal
  ...
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{p2img5}
  \end{figure}

  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{p2img6}
  \end{figure}

  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{p2img7}
  \end{figure}

\begin{lstlisting}
    5) Anadir ip a la pc
        ip 192.168.0.138 /25 192.168.0.129
    6) Anadir ip a la maquina virtual
        ip addr
        sudo ip addr add 192.168.0.10/25 broadcast 192.168.0.127 dev enp0s3
        ip addr
        sudo ip route add default via 192.168.0.1 dev enp0s3
\end{lstlisting}
    
    \begin{figure}[h]
        \includegraphics[width=0.85\textwidth]{p2img8}
      \end{figure}

\begin{lstlisting}
  7) Enruteo estático del router 1
      enable
      configure terminal
      ip route 10.10.0.132 255.255.255.252 10.10.0.130
      end
      enable
      configure terminal
      ip route 192.168.0.128 255.255.255.128 10.10.0.130
      end
  8) Enruteo estático del router 2
      enable
      configure terminal
  ...
  9) Enruteo estático del router 3
      enable
      configure terminal
  ...
  10) Usuario, Telnet y ssh router 1
      enable
      configure terminal
      username admin priv 0 password admin01
      ...
      login local
      exit
  11) Usuario, Telnet y ssh router 2
      enable
      configure terminal
      username admin priv 0 password admin01
      enable password 1234
      ...
      login local
      exit
  12) Usuario, Telnet y ssh router 3
      enable
      configure terminal
      username admin priv 0 password admin01
      enable password 1234
...
\begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{p2img4}
  \end{figure}

  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{p2img1}
  \end{figure}
  \begin{figure}[h]
    \includegraphics[width=0.85\textwidth]{p2img2}
  \end{figure}
