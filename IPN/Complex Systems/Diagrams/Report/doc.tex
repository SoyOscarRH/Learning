...
% =======================================================
    ...
    \lstdefinestyle{CompilandoStyle} {                              %This is Code Style
        ...
        basicstyle          = \fontCode\color{white},           %Style of text
    ...
    \lstset{style = CompilandoStyleSolarized, literate = {epsilon}{{\tiny$\epsilon$}}1 {empty}{{\tiny$\emptyset$}}1 }                          %Use this style
...
\begin{titlepage}
    ...
    {\fontsize{36}{50}\selectfont \textbf{REPORTE:\\
    Diagramas de Bruijn y \\ecuaciones}}\\[0.5cm] %Name of the book
...
\chapter{Diagramas de Bruijn}
  ...
  \begin{wrapfigure}{r}{0.35\textwidth}
      \centering
      \includegraphics[width=0.3\textwidth]{Graphics/Diagram.png}
  \end{wrapfigure}

  Los diagramas de Bruijn proporcionan una manera conveniente de describir las
  configuraciones de autómatas celulares (CA). 

  Sea $\Sigma$ el alfabeto y $s \geq 1$ un número, y el grafo de Bruijn 
  $B (s, \Sigma)$ como sigue: $B (s, \Sigma)$ tiene un conjunto de vértices $\Sigma^s$ y vertices
  $(ax, xb)$ para todo $a, b \in \Sigma, x \in \Sigma^s$.


  Para calcular estos tuve que mostrar las reglas de una manera que me permitiera
  facilmente crear los diagramas, para eso cree este pequeño programa en \texttt{C++} 
  que me permite mostrarlas de una manera comoda ss:
  \lstinputlisting[language=c++]{../Code/rules.cpp}
  
  Dando este resultado:
  \begin{multicols}{6}
    \lstinputlisting[language=c++]{../Code/result1.output}
  \end{multicols}

  Podemos editarlo un poco para saber el valor de las conexiones del diagrama:
  \lstinputlisting[language=c++]{../Code/connections.cpp}
  \begin{multicols}{3}
    \lstinputlisting[language=c++]{../Code/result2.output}
  \end{multicols}
  ...
  \begin{multicols}{2}
  \section{Regla 15}
    \includegraphics[width=0.45\textwidth]{Graphics/Diagram15.png}

  \section{Regla 22}
    \includegraphics[width=0.45\textwidth]{Graphics/Diagram22.png}

  \section{Regla 30}
    \includegraphics[width=0.45\textwidth]{Graphics/Diagram30.png}

  \section{Regla 54}
    \includegraphics[width=0.45\textwidth]{Graphics/Diagram54.png}

  \section{Regla 90}
    \includegraphics[width=0.45\textwidth]{Graphics/Diagram90.png}

  \section{Regla 110}
    \includegraphics[width=0.45\textwidth]{Graphics/Diagram110.png}
  \end{multicols}

  \clearpage

\chapter{Ecuaciones simbólicas (expresiones regulares)}

  Una vez que construyeron los diagramas podemos calcular todas las ecuaciones simbólicas 
  (expresiones regulares). Hasta calcular la ecuación que representa todo el autómata.
  ...
  Podemos crear un programa que se encarge de generar estas ecuaciones para la regla
  22 por ejemplo:
  \lstinputlisting[language=c]{../Code/showRule.ts}

  Logrando estas ecuaciones para la regla 15:
  \lstinputlisting[language=c]{../Code/ecuations.15}

  Logrando estas ecuaciones para la regla 22:
  \lstinputlisting[language=c]{../Code/ecuations.22}

  Logrando estas ecuaciones para la regla 30:
  \lstinputlisting[language=c]{../Code/ecuations.30}

  Logrando estas ecuaciones para la regla 54:
  \lstinputlisting[language=c]{../Code/ecuations.54}

  Logrando estas ecuaciones para la regla 90:
  \lstinputlisting[language=c]{../Code/ecuations.90}

  Logrando estas ecuaciones para la regla 110:
  \lstinputlisting[language=c]{../Code/ecuations.110}
...
\begin{thebibliography}{10}
  ...
  \bibitem{Genaro} 
      \textit{On Patterns and Dynamics of Rule 22 Cellular Automaton}. 
      Genaro J. Martínez,
      Andrew Adamatzky,
      Rolf Hoffmann,
      Rennes, France,
