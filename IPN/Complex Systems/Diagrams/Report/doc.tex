...
\chapter{Diagramas de Bruijn}
  ...
  \begin{multicols}{6}
    \lstinputlisting[language=c++]{../Code/result1.outupt}
  \end{multicols}
  ...
  \begin{multicols}{3}
    \lstinputlisting[language=c++]{../Code/result2.outupt}
  \end{multicols}
...
\chapter{Ecuaciones simbólicas (expresiones regulares)}
  ...
  Podemos crear un programa que se encarge de generar estas ecuaciones:
  \lstinputlisting{../Code/showRule.ts}
