...
\chapter{Diagramas de Bruijn}
  ...
  \section{Regla 15}
    \includegraphics[width=0.6\textwidth]{Graphics/Diagram15.png}

  \section{Regla 22}
    \includegraphics[width=0.6\textwidth]{Graphics/Diagram22.png}

  \section{Regla 30}
    \includegraphics[width=0.6\textwidth]{Graphics/Diagram30.png}

  \section{Regla 54}
    \includegraphics[width=0.6\textwidth]{Graphics/Diagram54.png}

  \section{Regla 90}
    \includegraphics[width=0.6\textwidth]{Graphics/Diagram90.png}

  \section{Regla 110}
    \includegraphics[width=0.6\textwidth]{Graphics/Diagram110.png}
