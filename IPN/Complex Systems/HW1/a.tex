...
\title{¿Dónde hay grupos de trabajo enfocados en el estudio de la complejidad en México?}
...
\section{Dentro del Instituto Politécnico Nacional}

  \begin{itemize}
    \item Centro de Sistemas Complejos IPN (CCSIPN, IPN) \url{http://comunidad.escom.ipn.mx/sistemascomplejos/}
    \item Grupo Mecánica Fractal (ESIME, IPN) \url{http://www.mfractal.esimez.ipn.mx/}
    \item Laboratorio de Sistemas Complejos (UPIITA, IPN) \url{https://sites.google.com/site/guzmanlev/}
    \item Departamento de Microcomputadoras (IC, UAP) \url{http://delta.cs.cinvestav.mx/~mcintosh/}
    \item Red de Investigación: Complejidad, Ciencia y Sociedad (CCS, Conacyt) \url{http://www.red-ccs.org/}
    \item Doctorado Transdiciplinario: Desarrollo Científico y Técnológico para la Sociedad (CINVESTAV, IPN) \url{http://transdisciplinario.cinvestav.mx/}
  \end{itemize}

\section{Fuera del Instituto Politécnico Nacional}

  \begin{itemize}
    \item Mexican Institute of Complex Systems (MICS) \url{http://mics.edu.mx/mics.html}
    \item Maestría en Ciencias de la Complejidad (UACM) \url{https://www.uacm.edu.mx/posgrado/cienciasdelacomplejidad/Presentacion}
    \item Laboratorio de Ciencias de la Computación (LCCOMP) \url{http://uncomp.uwe.ac.uk/LCCOMP/}
    \item Programa de Estudios sobre Complejidad, Cognición e Instituciones (UAM-X) \url{https://sites.google.com/site/uamxpecci/proyecto}
    \item Laboratorio de Redes Complejas (DMAp-IPICYT, San Luis Potosí) \url{http://www.ipicyt.edu.mx/Matematicas_Aplicadas/areas_matematicas_aplicadas_redes_complejas.php}
    \item Cibernética y Sistemas Complejos (CCADET, UNAM) \url{http://www.ccadet.unam.mx/secciones/depar/sub4/cibsc/cibs.html}
    \item Self-organizing Systems Lab (IMMAS, UNAM) \url{http://www.ccadet.unam.mx/secciones/depar/sub4/cibsc/cibs.html}
    \item Laboratorio de Comunicación Compleja (CEIICH, UNAM) \url{http://labcomplex.ceiich.unam.mx/labcomplex02/categoria.php?id=693}
    \item Centro de Ciencias de la Complejidad (C3, UNAM) \url{http://c3.fisica.unam.mx/}
    \item Departamento de Sistemas Complejos (Ciencias, UNAM) \url{http://scifunam.fisica.unam.mx/}
    \item Dinámica No Lineal y Sistemas Complejos (DNLySC, UACM) \url{http://www.nolineal.org.mx/}
  \end{itemize}
