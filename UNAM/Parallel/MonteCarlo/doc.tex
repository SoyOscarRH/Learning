...
\title{Monte carlo y las integrales dobles}

\author{
    Oscar Andrés Rosas Hernández
    \textit{
        Facultad de Ciencias, UNAM, CDM
    }
}


\markboth{SEMINARIO DE CIENCIAS DE LA COMPUTACIÓN}{}


\maketitle


Para esta tarea teniamos que encontrar la masa asi como el centro
de masas de dos laminas.

\section{2 Puntos}

Lo primero que teniamos que hacer era programar un codigo en c
que fuera capaz de resolver nuestros problemas, a continuacion muestro
mis ideas, lo primero era hacerlo sin usar computacion en paralelo:
\lstinputlisting[language=c]{code.c}

Ahora a añadir la parte paralela:
\lstinputlisting[language=c]{codeparallel.c}

La idea es sencilla, hacer una funcion para calcular numero 
aleatorios en un rango, hacer una funcion para aproximar la 
integral usando la formula y finalmente mostrar resultados.

Use MPI para dividir segun el ID, siendo este el encargado de 
recolectar los resultados nada mas y use barrier para esperar
...
\section{4 Puntos: Resultados}

Ahora podremos ver los resultados de ambos lados a continuacion:
\begin{multicols}{2}

    Primero del servidor:
    \lstinputlisting[language=c]{b.output}

    Luego el mio:
    \lstinputlisting[language=c]{b.outputmine}
\end{multicols}

Aqui podemos ver varios ejemplos de prueba que hice:

\includegraphics[width=0.45\textwidth]{Evidence1.png}
\includegraphics[width=0.45\textwidth]{Evidence2.png}


\section{2 Puntos: Tiempo}
Ahora resulta que mi programa ya no da el tiempo:
\begin{itemize}
    \item Con mi computadora: 0.079008
    \item Con el servidor:    0.013798
\end{itemize}

Por lo tanto el servidor es unas 7 veces mas rapido a igualdad de procesos (4).
\clearpage
\section{2 Puntos: Errores}

Mi programa ya calcula los errores pero si lo quieren en una tabla aqui esta:
\subsection{Mi compu}
\subsection{Primera funcion de densidad}
Masa
\begin{table}[ht!]
    \begin{tabular}{|l|l|l|l|}
        \hline
        N       & Aproximacion & Valor real & Error relativo \\ \hline \hline
        10      &  1.462352    &  1.500000  &  0.025099      \\ \hline
        100     &  1.564907    &  1.500000  &  0.043272      \\ \hline
        1000    &  1.484954    &  1.500000  &  0.010031      \\ \hline
        10000   &  1.506648    &  1.500000  &  0.004432      \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[ht!]
    \begin{tabular}{|l|l|l|l|}
        \hline
        N       & Aproximacion & Valor real & Error relativo \\ \hline \hline
        10      &  0.480025    &  0.5556    &  0.136025      \\ \hline
        100     &  0.631424    &  0.5556    &  0.136472      \\ \hline
        1000    &  0.508084    &  0.5556    &  0.085523      \\ \hline
        10000   &  0.549873    &  0.5556    &  0.010308      \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[ht!]
    \begin{tabular}{|l|l|l|l|}
        \hline
        N       & Aproximacion & Valor real & Error relativo \\ \hline \hline
        10      &  0.500611    &  0.6110    &  0.180669      \\ \hline
        100     &  0.506614    &  0.6110    &  0.170845      \\ \hline
        1000    &  0.560789    &  0.6110    &  0.082178      \\ \hline
        10000   &  0.602674    &  0.6110    &  0.013627      \\ \hline
    \end{tabular}
\end{table}

\subsection{Segunda funcion de densidad}
Masa
\begin{table}[ht!]
    \begin{tabular}{|l|l|l|l|}
        \hline
        N       & Aproximacion & Valor real & Error relativo \\ \hline \hline
        10      &  2.665837    &  2.6635    &  0.000877      \\ \hline
        100     &  2.705578    &  2.6635    &  0.015798      \\ \hline
        1000    &  2.625188    &  2.6635    &  0.014384      \\ \hline
        10000   &  2.672327    &  2.6635    &  0.003314      \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[ht!]
    \begin{tabular}{|l|l|l|l|}
        \hline
        N       & Aproximacion & Valor real & Error relativo \\ \hline \hline
        10      &  0.108239    &  0.0000    &  0.108239      \\ \hline
        100     &  0.123492    &  0.0000    &  0.123492      \\ \hline
        1000    &  0.019555    &  0.0000    &  0.019555      \\ \hline
        10000   &  0.001202    &  0.0000    &  0.001202      \\ \hline
    \end{tabular}
\end{table}
...
\begin{table}[ht!]
    \begin{tabular}{|l|l|l|l|}
        \hline
        N       & Aproximacion & Valor real & Error relativo \\ \hline \hline
        10      &  0.450652    &  0.0000    &  0.450652      \\ \hline
        100     & -0.039221    &  0.0000    &  0.039221      \\ \hline
        1000    &  0.021004    &  0.0000    &  0.021004      \\ \hline
        10000   &  0.018976    &  0.0000    &  0.018976      \\ \hline
    \end{tabular}
\end{table}
\subsection{El servidor}
Podria escribirlo pero ya esta el archivo de salida, y es 
bastante tardado hacerlo hacer la tabla en \LaTeX
