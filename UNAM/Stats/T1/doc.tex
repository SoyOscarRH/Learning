...
% =======================================================
    ...
    % *********   DOCUMENT ITSELF   **************
    \documentclass[12pt, fleqn, journal]{IEEEtran}                  %Type of doc and size of font and left equations
...
Sea $X_1, \dots, X_n$ variables aleatorias tal que $X_i \sim exp(\lambda)$.

\begin{itemize}
  \item 
    Usando las propiedades de la varianza y de la esperanza:

    \begin{itemize}
      \item 
        Para la esperanza podemos saber que:
        \begin{align*}
          E(X_1 + \dots + X_n)
              &= E(X_1) + \dots + E(X_n)
                  && \Remember{propiedad de la esperanza}                                       \\
              &= \frac{1}{\lambda} + \dots + \frac{1}{\lambda}
                  && \Remember{Como es una exponencial entonces $E(X_i) = \frac{1}{\lambda}$}   \\
              &= \frac{n}{\lambda}
        \end{align*}
      
        \item 
        Para la varianza podemos saber que:
        \begin{align*}
          V(X_1 + \dots + X_n)
              &= \sum_{i = 1}^n V(X_i) + 2 \sum_{i < j} Cov(X_i, X_j)
                  && \Remember{propiedad de la varianza}                                        \\
              &= \sum_{i = 1}^n V(X_i) + 0
                  && \Remember{Son independientes, por lo tanto su covarianza es 0}             \\
    ...
    \item 
     Usando las propiedades de la suma podemos ver que $X_1, \dots, X_n \sim Gamma(n, \lambda)$ 
     Entonces podemos sacarlas de formulario:
     \begin{itemize}
       \item $E(X_1, \dots, X_n) = \frac{n}{\lambda}$
       \item $Var(X_1, \dots, X_n) = \frac{n}{\lambda^2}$
     \end{itemize}
\end{itemize}

Ahora demos la funcion de distribuciones:
\begin{align*}
  f_{X_1 + \dots + X_n}(X_1, \dots, X_n) 
      &= \prod_{i = 1}^n f_{X_i}(X_i)            \\
      &= \prod_{i = 1}^n \lambda e^{-\lambda x_i}  \\
      &= \lambda e^{-\lambda \sum_{i = 1}^n x_i}
\end{align*}
