...
\begin{titlepage}
    ...
    {\fontsize{65}{78}\selectfont \textbf{Tarea Random}}\\[0.5cm]   %Name of the book
...
\clearpage
    ...
    % ==============================================
    \clearpage
    \section{Interpolacion por Hermite}
            ...
            Recordemos que:
                \begin{largeEq}
                    \begin{MultiLineEquation*}{3}
                        H_{2n+1}(x)
                            &= \sum_{j=0}^n f(x_j) H_j(x) + \sum_{j=0}^n f'(x_j) \hat{H_j}(x) 
        ...
        \subsection{Ejemplo}
            ...
            \begin{multicols}{2}
                ...
                Sea $f(x) = e^{2x}$, por lo tanto $f'(x) = 2 e^x$
                Entonces:
                \begin{itemize}
                    \item $x_0 = 0$
                    \item $x_1 = 1$
                ...
                Entonces veamos como se ve el interpolante de Hermite, para hacerlo tenemos que
                calcular $H_0, H_1, H_2, \hat H_0, \hat H_1, \hat H_2$.

                Vamos paso por paso:
                \begin{MultiLineEquation*}{3}
                    L_0 (x) 
                        &= \dfrac{(x - x_1)(x - x_2)}{(x_0 - x_1)(x_0 - x_2)}   \\
                        &= \dfrac{(x - 1)(x - 2)}{(0 - 1)(0 - 2)}               \\
                        &= \dfrac{(x - 1)(x - 2)}{2}                            \\
                        &= \dfrac{x^2 - 3x + 2}{2}                              \\
                \end{MultiLineEquation*}
                ...
                \begin{MultiLineEquation*}{3}
                    L_1 (x) 
                    &= \dfrac{(x - x_0)(x - x_2)}{(x_1 - x_0)(x_1 - x_2)}   \\
                    &= \dfrac{(x - 0)(x - 2)}{(1 - 0)(1 - 2)}               \\
                    &= \dfrac{(x - 0)(x - 2)}{-1}                           \\
                    &= \dfrac{x^2 - 2x}{-1}                                 \\
                \end{MultiLineEquation*}
                ...
                \begin{MultiLineEquation*}{3}
                    L_2 (x) 
                        &= \dfrac{(x - x_0)(x - x_1)}{(x_2 - x_0)(x_2 - x_1)}   \\
                        &= \dfrac{(x - 0)(x - 1)}{(2 - 0)(2 - 1)}               \\
                        &= \dfrac{x^2 - x}{2}                                   \\
                \end{MultiLineEquation*}
            ...
            \end{multicols}
                ...
                Ahora si que podemos hacer las $H_i(x)$
                \begin{itemize}
                    \item $H_0(x)$ y $\hat H_0(x)$
                        \begin{MultiLineEquation*}{3}
                            H_0(x)
                                &= (1 - 2(x - x_0)L_0'(x_0))  L^2_0(x)        \\
                                &= (1 - 2(x - 0)L_0'(0))  L^2_0(x)            \\
                                &= (1 - 2(x - 0) \frac{-3}{2})  L^2_0(x)     \\
                                &= (1 + 3x)  \pfrac{x^2 - 3x + 2}{2}^2 
                        \end{MultiLineEquation*}

                        \begin{MultiLineEquation*}{3}
                            \hat H_0(x)
                                &= (x - 0) L_0^2(x)             \\
                                &= (x) \pfrac{x^2 - 3x + 2}{2}^2
                        \end{MultiLineEquation*}

                    \item $H_1(x)$ y $\hat H_1(x)$
                        \begin{MultiLineEquation*}{3}
                            H_1(x)
                                &= (1 - 2(x - x_1)L_1'(x_1))  L^2_1(x)        \\
                                &= (1 - 2(x - 1)L_1'(1))  L^2_1(x)            \\
                                &= (1 - 2(x - 1) 0)  L^2_1(x)                 \\
                                &= L^2_1(x)                                   \\
                                &= (x^2 - 2x)^2
                        \end{MultiLineEquation*}
                    ...
                    \item $H_2(x)$ y $\hat H_2(x)$
                        \begin{MultiLineEquation*}{3}
                            H_2(x)
                                &= (1 - 2(x - x_2)L_2'(x_2))  L^2_2(x)        \\
                                &= (1 - 2(x - 2)L_2'(2))  L^2_2(x)            \\
                                &= (1 - 2(x - 2)\frac{3}{2})  L^2_2(x)        \\
                                &= (1 - 2(x - 2)\frac{3}{2})\pfrac{x^2 - x}{2}^2            \\
                        \end{MultiLineEquation*}
            ...
            \begin{MultiLineEquation*}{3}
                H_{2n+1}(x)
                        &= \sum_{j=0}^n f(x_j) H_j(x) + \sum_{j=0}^n f'(x_j) \hat{H_j}(x)       \\
                        &= f(x_0) H_0(x) + f(x_1) H_1(x) + f(x_2) H_2(x) + 
                            f'(x_0) \hat{H_0}(x) + f'(x_1) \hat{H_1}(x) + f'(x_2) \hat{H_2}(x)   \\
                        &= 
                            1    \Wrap{H_0(x)} + 
                            e^2  \Wrap{H_1(x)} + 
                            e^4  \Wrap{H_2(x)} + 
                            ...
                            2e^4 \Wrap{\hat{H_2}(x)}        \\
                        &= 
                            1    \Wrap{(1 + 3x)  \pfrac{x^2 - 3x + 2}{2}^2} + 
                            e^2  \Wrap{(x^2 - 2x)^2} + 
                            e^4  \Wrap{(1 - 2(x - 2)\frac{3}{2})\pfrac{x^2 - x}{2}^2} 
                            \\
                            &+ 
                            2    \Wrap{(x) \pfrac{x^2 - 3x + 2}{2}^2} + 
                            2e^2 \Wrap{(x - 1) (x^2 - 2x)^2} + 
                            2e^4 \Wrap{(x - 2) \pfrac{x^2 - x}{2}^2 }        \\
            \end{MultiLineEquation*}
            \end{SmallIndentation}
