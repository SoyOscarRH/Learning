...
\begin{titlepage}
    ...
    {\fontsize{65}{78}\selectfont \textbf{Tarea 4}}\\[0.5cm]        %Name of the book
...
\clearpage
    ...
    \section{Problemas de Computadora}
        ...
        \subsection{Notas}
            ...
            \begin{itemize}
                \item Que $|f(x)| < tolerance$
                \item Que $|x_{k+1} - x_k| < tolerance$
            \end{itemize}

            Así que cuando tu me mandas una tolerancia en cualquiera de los métodos la solución
            que recibes de regrese cumple con \textbf{alguna} de las condiciones que he dicho antes.
        ...
        \subsection{1}
            ...
            Despúes de esto tienes acceso a una variable llamada $estimation$ por si quieres probar
            algo.

            \end{SmallIndentation}

            \lstinputlisting[language=scilab, gobble=12]{Code/1.sce}
        ...
        \subsection{2}
            ...
            \lstinputlisting[language=scilab, gobble=12]{Code/2.sce}
        ...
        \subsection{4}
            ...
            \lstinputlisting[language=scilab, gobble=12]{Code/4.sce}
        ...
        \subsection{9}
            ...
            En este código muestra justo lo que se nos pide y pues nos muestra como es que 
            se comporta de función $g(x)$ comparandola con la identidad y el punto en donde
            se intersectan calculado usando las iteraciones de punto fijo

            \end{SmallIndentation}

            \lstinputlisting[language=scilab, gobble=12]{Code/9.sce}
        ...
        \end{SmallIndentation}
            ...
            \lstinputlisting[language=scilab, gobble=12]{Code/13.sce}
            \lstinputlisting[language=scilab, gobble=12]{Code/14.sce}
            \lstinputlisting[language=scilab, gobble=12]{Code/14.sce}
        ...
        \subsection{16}
            ...
            \lstinputlisting[language=scilab, gobble=12]{Code/16.sce}
        ...
        \subsection{18}
            ...
            En este código nos da dos métodos, y ahhhhh, este si me costo un rato, así que añadiré un fragmento del
            texto que explica como funciona esto:

                    
            % ==============================================================
            % ======              USARLO PARA SQRT(A)               ========
            % ==============================================================
            \subsubsection{Usar Newton para calcular la $\sqrt[n]{A}$}
            ...
            % ======              USARLO PARA SQRT(A)               ========
            % ==============================================================
            \subsubsection{¿Como calcular raíces de números negativos?}

                Ok, si quieres usar Newton para calcular raices de números positivos no hay problema.

                Ahora, si es negativo pero la n-abla raíz es impar entonces tampoco hay problema basta
                con calcular la raíz absoluta y luego negar la respuesta, pero, pero que pasa si tratamos
                con un número negativo y una raíz n-abla par.

                En ese caso lo que podemos calcular es con este método es $r$ del número complejo $re^{i\theta}$

                Ahora, solo usamos nuestro formulazo para sacar $\theta$ y pasarlo a forma rectangular y listo :v
            ...
            \lstinputlisting[language=scilab, gobble=12]{Code/Algorithms/NRootNewtonRaphson.sci}
        ...
        \subsection{19}
            ...
            \begin{itemize}
                \item La primera opción queda como anillo al dedo porque cumple con todas las restricciones
                    así que no hay mucho que comentar
                \item Pero la segunda, se toma casi el doble de iteraciones y no llega a un punto válido según
                    las restricciones, pero eso se debe basicamente a la periodicidad de las trigonometricas
            \end{itemize}
        ...
        \subsection{20}
            ...
            \begin{itemize}
                \item La primera opción nos muestra una respuesta, una buena respuesta
                \item La segunda casi casi niega el primer término de la primera pero la
                    segunda componente se mueve $pi$
                \item Finalmente la tercera se comporta igual se mueve y salta $2\pi$
                    causado por la periodicidad de las trigonometricas
            \end{itemize}
        ...
        \subsection{21}
            ...
            \lstinputlisting[language=scilab, gobble=12]{Code/21a.sce}
            \lstinputlisting[language=scilab, gobble=12]{Code/21b.sce}
            \lstinputlisting[language=scilab, gobble=12]{Code/21c.sce}
        ...
        \subsection{22}
            ...
            \lstinputlisting[language=scilab, gobble=12]{Code/22.sce}
    ...
    \section{Anexo}
        ...
        \lstinputlisting[language=scilab, gobble=12]{Code/Algorithms/Bisection.sci}

        \clearpage
        \subsection{FixedPoint}
        \lstinputlisting[language=scilab, gobble=12]{Code/Algorithms/FixedPoint.sci}

        \subsection{Helpers}
        \lstinputlisting[language=scilab, gobble=12]{Code/Algorithms/Helpers.sci}

        \clearpage
        \subsection{NewtonRaphson}
        \lstinputlisting[language=scilab, gobble=12]{Code/Algorithms/NewtonRaphson.sci}

        \clearpage
        \subsection{NewtonSecant}
        \lstinputlisting[language=scilab, gobble=12]{Code/Algorithms/NewtonSecant.sci}

        \clearpage
        \subsection{RegulaFalsi}
        \lstinputlisting[language=scilab, gobble=12]{Code/Algorithms/RegulaFalsi.sci}
