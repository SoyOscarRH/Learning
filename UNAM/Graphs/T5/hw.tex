...
\title{Tarea 5: Gráficas y Juegos}
...
\maketitle
    ...
    \section*{1 Problema}
        ...
        \begin{figure}[h]
          \includegraphics[width=0.4\textwidth]{g1}
          \centering
        \end{figure}
        
        \begin{itemize}
            \item  Da tres apareamientos maximos.
            
            Claro, faltaría mas :D
            ...
            \clearpage
            \item Da un apareamiento maximal que no sea maximo
            
            \begin{figure}[h]
                \includegraphics[width=0.3\textwidth]{g3}
            \end{figure}
            
            \item Da el numero de apareamiento de la grafica: 4
            \item ¿Se puede dar un apareamiento perfecto?
            
            No, esto no espera ser una demostracion super formal, pero la idea
            es esta, primero que nada, si buscamos un apareamiento perfecto entonces
            este tiene que incluir al vertice i, sin perdida de generalidad y por la
            naturaleza de las grafica podemos suponer que elegimos el vertice $ai$,
            ahora, vamos poniendo vertices adicionales siguiendo la idea de que siga
            siendo un apareamiento, (podemos descontar a las demas aristas que tocan a $i$)
            y llegamos a un dibujo que ya hemos visto.

            \includegraphics[width=0.2\textwidth]{g4}

            No se puede hacer algo mejor que eso :c
      \end{itemize}
    ...
    \section*{2 Problema}
      ...
      \begin{figure}[h]
        \includegraphics[width=0.4\textwidth]{2q}
        \centering
      \end{figure}
    ...
    \section*{3 Problema}
      ...
      Tomando en cuenta las graficas G y H de las dos preguntas anteriores, 
      contesta lo siguiente:

      \begin{itemize}
        \item ¿G es 1 - factorizable?, si es asi, da una factorizacion
        
          No, y la idea es muy sencilla, hay un teorema que vimos en clase muy bonito, 
          y es que si una grafica es 1-factorizable entonces debe ser una grafica regular.

          Recordemos que una grafica regular es aquella en las que todos los vertices tienen
          el mismo grado.

          Ahora enunciemos las mismas ideas que teniamos antes:
          Si una grafica NO es regular entonces no es 1-factorizable.

          Y resulta que en G tenemos que $grado(i) = 8$ y $grado(a) = 3$.

        \item ¿H es 1 - factorizable?, si es asi, da una factorizacion
        
          Siguiendo la misma idea que arriba: 
          resulta que en H tenemos que $grado(f) = 5$ y $grado(a) = 3$.
    ...
    \begin{figure}[h]
        \includegraphics[width=0.4\textwidth]{5q}
        \centering
    \end{figure}
    ...
    \begin{figure}[h]
        \includegraphics[width=0.8\textwidth]{5-2}
        \centering
    \end{figure}
