...
\begin{titlepage}
    ...
    {\fontsize{45}{52}\selectfont \textbf{Retos 2}}\\[0.5cm]        %Name of the book
...
\section{1}
    ...
    \begin{itemize}
        \item Suponte que $A$ es falso, entonces el cofre no esta
        ahi, ni en el b, ni en el b, por lo tanto esta en el C.
        \item ... Ya, creo que ya quedo
    \end{itemize}
...
\section{2}
    ...
    El cuadrado es sencillo de calcular, tiene un lado de tamaño $2cm$
    entonces, solo basta calcular la diagonal del mismo.

    Esto sale por pitagoras, $r^2 = 2^2 + 2^2 = 4 + 4 = 8$, por lo
    tanto es la raíz de 8.
...
\section{3}
    ...
    Esta es un clasico, sale con la formula de Euler:
   $caras - aristas + vertices = 2$

   Por lo tanto tenemos que:
   $20 - (20 * 6 +12 * 5) \\ 2 + v = 2$

   Por lo tanto $vertices = 60$
...
\section{4}
   ...
   Lo que necesitamos es encontrar un número que divida a todos, es
   decir $LCM(1, 2, 3, 4, 5, 6, 7) = 420$
...
\section{5}
   ...
   Lo que pasa es que efectivamente nos movemos 1 metro cada dia, pero 3 por la 
   mañana, por lo tanto lo que estamos buscando es la $n$ mas pequeña que cumple
   que $(n - 1)+ 3 \geq 30$. Esto sería 27 días despues.
...
\section{8}
   ...
   Es una ecuación diofantica:
   \begin{itemize}
       \item $5x + 10y = 350$
       \item $x+y=50$
   \end{itemize}

   El primero se puede hacer mas sencillo:
   $x + 2y = 70$

   Por lo tanto $x = 30$  $y = 20$
