...
\begin{titlepage}
    ...
    \Huge{Visita al Edificio Inteligente}
...
\clearpage
    ...
    \section{Evidencias}
        ...
        \begin{figure}[h]
            \centering
            \includegraphics[width=0.65\textwidth]{Visita2}
        \end{figure}


        \begin{figure}[h]
            \centering
            \includegraphics[width=0.65\textwidth]{Visita1}
        \end{figure}
