...
\begin{titlepage}
    ...
    {\fontsize{50}{65}\selectfont 
        \textbf{Análisis Recursivo}}\\[0.5cm]                       %Name of the book
...
\section{Algoritmo 1}
    ...
    \subsection{Código}
        ...
        \lstinputlisting[language=C, gobble=8]{Code/1.c}
...
\section{Algoritmo 4}
    ...
    \subsection{Código}
        ...
        \lstinputlisting[language=C, gobble=8]{Code/4.c}
...
\section{Algoritmo 5}
    ...
    \subsection{Código}
        ...
        \lstinputlisting[language=C, gobble=8]{Code/5.c}
